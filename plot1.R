...
# and plot histogram of energy consumption for two days i.e 2007-02-01 & 2007-02-01.
...
#plotting histogram
hist(twoDaysData$Global_active_power, col="#f5300a", xlab = "Global Active Power(kilowatts)", main="Global Active Power")
